...
Label list_Game[NUM_GAMES] = {
		{"BATMAN RETURNS", &batman_returns, &batman_returns_dark, NULL, NULL, 0, 0, 0x10},
		{"CHAMPIONSHIP PRO-AM", &championship_pro, &championship_pro_dark, NULL, NULL, 0, 0, 0x02},
		{"FANTASIA", &fantasia, &fantasia_dark, NULL, NULL, 0, 0, 0x0C},
		{"TALESPIN", &talespin, &talespin_dark, NULL, NULL, 0, 0, 0x08},
		{"TINY TOON ADVENTURES", &tiny_toon, &tiny_toon_dark, NULL, NULL, 0, 0, 0x04},
		{"TOM AND JERRY - FRANTIC ANTICS", &tom_and_gerry, &tom_and_gerry_dark, NULL, NULL, 0, 0, 0x18},
};
