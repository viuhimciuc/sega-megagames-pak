...
Label list_Game[NUM_GAMES] = {
		{"SPACE INVADERS '91", &space_invaders, &space_invaders_dark, NULL, NULL, 0, 0, 0x02},
		{"ARIEL THE LITTLE MERMAID", &ariel, &ariel_dark, NULL, NULL, 0, 0, 0x0C},
		{"OUTRUN", &outrun, &outrun_dark, NULL, NULL, 0, 0, 0x10},
		{"ROBOCOP 3", &robocop_3, &robocop_3_dark, NULL, NULL, 0, 0, 0x04},
		{"TROUBLE SHOOTER", &trouble_shooter, &trouble_shooter_dark, NULL, NULL, 0, 0, 0x08},
		{"X-MEN", &xman, &xman_dark, NULL, NULL, 0, 0, 0x18},
};
