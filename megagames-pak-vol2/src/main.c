...
Label list_Game[NUM_GAMES] = {
		{"ALEX KIDD IN THE ENCHANTED CASTLE", &alex_kidd, &alex_kidd_dark, NULL, NULL, 0, 0, 0x02},
		{"ALIEN 3", &alien_3, &alien_3_dark, NULL, NULL, 0, 0, 0x04},
		{"JOE & MAC", &joe_mac, &joe_mac_dark, NULL, NULL, 0, 0, 0x10},
		{"THE LOST VIKINGS", &lost_vikings, &lost_vikings_dark, NULL, NULL, 0, 0, 0x18},
		{"THUNDER FORCE II", &thunder_force_2, &thunder_force_2_dark, NULL, NULL, 0, 0, 0x08},
		{"THUNDER FORCE III", &thunder_force_3, &thunder_force_3_dark, NULL, NULL, 0, 0, 0x0C},
};
